            ...
            {sortedItems.map((item) => {
              ...
              return (
                <tr key={item.id} className={`group transition-all hover:bg-slate-50 ${isSelected ? 'bg-blue-50/50' : ''}`}>
                  ...
                  <td className="p-2 sm:p-4">
                    <div className="flex flex-col">
                      ...
                      <div className="flex flex-wrap items-center gap-x-2 sm:gap-x-3 gap-y-1 mt-1">
                        <span className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest">{item.category}</span>
                  ...
                  <td className="p-2 sm:p-4">
                    <div className="flex flex-col">
                      <span className="text-[10px] sm:text-xs font-bold text-slate-600 truncate max-w-[100px] sm:max-w-[120px]">{item.model || '-'}</span>
                      <span className="text-[9px] sm:text-[10px] font-mono font-bold text-slate-400 mt-0.5">{item.dimensions || '-'}</span>
                    </div>
                  </td>
